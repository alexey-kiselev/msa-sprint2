...
`Booking` даёт максимум ценности при приемлемой сложности и управляемых рисках.

| Критерий                   | Booking                          | Hotel               | User      | Promo     | Review    |
| -------------------------- | -------------------------------- | ------------------- | --------- | --------- | --------- |
| Ценность для бизнеса       | высокая                          | высокая             | средняя   | ниже      | ниже      |
| Сложность вынесения        | средняя (шлюз к монолиту)        | выше (много связей) | средняя   | ниже      | ниже      |
| Объём сервиса              | умеренный                        | крупный             | умеренный | небольшой | небольшой |
| Риски миграции             | контролируемые (Strangler + ACS) | выше                | средние   | низкие    | низкие    |
| Масштабирование и нагрузка | узкое место                      | важно               | ниже      | ниже      | ниже      |
